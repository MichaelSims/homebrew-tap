class JasprBeta < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/MichaelSims/git-jaspr/releases/download/v2.1.1-beta.2/jaspr-macos-arm64"
      sha256 "fc54413a29ec53849cc0bd9e49d78c4eeef837cb16539921263d14de5c30b852"
    end
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/MichaelSims/git-jaspr/releases/download/v2.1.1-beta.2/jaspr-linux-amd64"
      sha256 "33e34e65595313a230d4b97d524b2077d8119942964f3c7241675c42c0259bc9"
    end
  end

  resource "bash_completion" do
    url "https://github.com/MichaelSims/git-jaspr/releases/download/v2.1.1-beta.2/jaspr.bash"
    sha256 "18b2a66f54cd2e25a6d9d98ddaf0bae8b0d66805fb3e106c6a74399a1d3ff993"
  end

  resource "zsh_completion" do
    url "https://github.com/MichaelSims/git-jaspr/releases/download/v2.1.1-beta.2/_jaspr"
    sha256 "31fc222a68cdc03c8868dbf38f1effa8252a3863268214d805c7aa0f89f3ad81"
  end

  resource "fish_completion" do
    url "https://github.com/MichaelSims/git-jaspr/releases/download/v2.1.1-beta.2/jaspr.fish"
    sha256 "0a2779e7158289bfae94c1c1247ea7d22460051113ef753e2d86a5610a38d7eb"
  end

  resource "man_page" do
    url "https://github.com/MichaelSims/git-jaspr/releases/download/v2.1.1-beta.2/jaspr.1"
    sha256 "3aaddd5b0a9855ce23589f92452a4b936aeef0ac17fe45ed741cc9b2c9021b7e"
  end
